...
<asp:MultiView ID="mv" runat="server" ActiveViewIndex="0">
    <asp:View ID="vwImport" runat="server">
        ...
        <div class="uBlogsy_row">
            <label>
                Use month folders? (First disable "Auto Sorting") </label>
        ...
        <div class="uBlogsy_row">
            Note: When "Use Auto Sorting" is enabled (under the General Settings tab), your posts will be created with year-month-day folders.
        </div>
        ...
        This tool is in Beta. Please report any issues <a href="http://our.umbraco.org/projects/starter-kits/ublogsy/ublogsy-bugs">
            here</a>
    </asp:View>
